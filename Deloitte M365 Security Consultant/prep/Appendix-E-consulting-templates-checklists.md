...
>
> **Candidate honesty note:** Arti can use these artifacts to demonstrate structured discovery, support discipline, troubleshooting, executive communication, and design reasoning. She should distinguish a template she can apply from a production deliverable she personally owned. A credible phrase is: "I would adapt this public template with the accountable client owner, validate it against the statement of work and evidence, and obtain the required security, legal, architecture, operations, and change approvals."
