...
Arti may directly claim SharePoint Online, OneDrive, sync, M365 support, critical incidents, RCA, customer/stakeholder work and her accurately documented Power Automate/Power Apps/Copilot Studio/AI learning or project evidence. Those create a credible bridge to low-code and Copilot security because permissions, sharing, connections and workflow ownership are central.

She should not imply production ownership of Microsoft 365 Apps security baselines, macro/ASR deployment, Power Platform tenant governance, Dataverse security, DLP policy administration, Managed Environments, service-principal ALM, Microsoft 365 Copilot rollout, semantic index, Purview for AI, Defender AI controls or agent security unless true and evidenced. Safe wording is:
...
A **declarative agent** configures instructions, knowledge and supported tools on Microsoft's orchestration/model capabilities. A **custom engine agent** uses a custom orchestration/model/runtime and integrates into Microsoft experiences through supported interfaces. Copilot Studio agents can combine topics/generative orchestration, knowledge and connectors/actions. Terminology and packaging are highly change-sensitive.
