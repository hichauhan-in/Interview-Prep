...
> 💡 **Tie-in to your background:** "works on mobile data but not on corporate wifi" is a diagnostic you have run many times before. It is one of the fastest ways to separate a network/DNS problem from an application problem, and it costs the customer thirty seconds. Keep it as a first-line question.
